#!/usr/bin/env python3
"""Build a short, trusted Stage1 calibration set targeting MA/SE specificity."""
...
LESIONS = ("MA", "HE", "EX", "SE")
QUOTAS = {
    "MA": {"present": 350, "absent": 300},
    "HE": {"present": 400, "absent": 200},
    "EX": {"present": 400, "absent": 200},
    "SE": {"present": 300, "absent": 500},
}
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("data/annotation_v4/fundus_stage1_en_cot_targeted_calibration_train_sft.jsonl"))
    parser.add_argument("--stats", type=Path, default=Path("data/annotation_v4/fundus_stage1_en_cot_targeted_calibration_stats.json"))
    ...
    for lesion in LESIONS:
        ...
        for state in ("present", "absent"):
            ...
            for row in chosen:
                ...
                item["meta"]["split"] = "targeted_calibration_train"
                item["meta"]["targeted_calibration"] = True
    ...
    result = {
        "version": "fundus_stage1_targeted_calibration_v1",
        "seed": args.seed,
