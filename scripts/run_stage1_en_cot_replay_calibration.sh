...
ADAPTER_DIR="$ROOT/saves/qwen3-vl-8b-fundus/lora/stage1_en_cot_replay_calibrated"
EVAL_ROOT="$ROOT/saves/qwen3-vl-8b-fundus/lora/stage1_eval/replay_calibration"
LOG_DIR="$ROOT/logs/stage1_en_cot_replay_calibration"
BASELINE="$PROJECT/reports/metrics/stage1_en_cot_gold_dev_metrics.json"

mkdir -p "$LOG_DIR" "$EVAL_ROOT/gold_dev"
cd "$ROOT"

"$PYTHON" "$PROJECT/scripts/fundus_v4/build_stage1_en_cot_replay_calibration.py" \
...
data["fundus_stage1_en_cot_replay_calibration_train"] = {
    "file_name": "fundus_stage1_en_cot_replay_calibration_train_sft.jsonl",
    "formatting": "sharegpt",
...
"$CLI" train "$PROJECT/configs/train/stage1_en_cot_replay_calibration.yaml" \
